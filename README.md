...
foreground service and a start/stop screen — confirmed working on real devices. A pre-built APK
is available under [Releases](https://github.com/LucyWolf/phobos-bot/releases) if you'd rather
...
Foreground-Service und Start/Stop-Bildschirm verpackt — läuft nachweislich auf echten Geräten.
Eine fertig gebaute APK gibt's unter [Releases](https://github.com/LucyWolf/phobos-bot/releases),
falls du sie nicht selbst bauen willst.
