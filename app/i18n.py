TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "events_announce_hint":       "(optional, postet eine Nachricht in diesen Kanal bei Erstellung)",
    ...
    "en": {
        ...
        "events_announce_hint":       "(optional, posts a message in this channel when created)",
